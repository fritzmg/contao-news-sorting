...
> [!NOTE]
> Install [`inspiredminds/contao-categories-news-filter`](https://github.com/inspiredminds/contao-categories-news-filter) for compatibility with [`codefog/contao-news_categories`](https://github.com/codefog/contao-news_categories).
